 ...
 * @author Gabriel
 */
public class TelaCadastrarItemEntrada extends JDialog implements ActionListener {
    ...
    public TelaCadastrarItemEntrada(EstoqueEntrada estoqueEntrada) {
        setModal(true);
        setResizable(false);
        setTitle("Cadastrar Item Entrada");
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (evento.getSource().equals(botaoSalvar)) {
            try {
                ConstrutorItemEntrada construtorItemEntrada;

                construtorItemEntrada = new ConstrutorItemEntrada(
                        (Produto) comboProduto.getSelectedItem(),
                        Integer.parseInt(textQuantidade.getText()),
                        estoqueEntrada
                );

                ItemEntradaUC.salvarItemEntrada(construtorItemEntrada);
